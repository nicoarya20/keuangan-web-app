      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="p-4 lg:p-5 bg-white rounded-2xl shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-[10px] lg:text-xs text-gray-500 mt-2">This month</p>
              </div>
              <div className="w-8 h-8 lg:w-10 lg:h-10 bg-indigo-50 rounded-xl flex items-center justify-center">
                <Wallet className="w-4 h-4 lg:w-5 lg:h-5 text-indigo-600" />
              </div>
            </div>
          </Card>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <span className="text-[10px] lg:text-xs text-green-600">+12.5%</span>
                </div>
              </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <span className="text-[10px] lg:text-xs text-red-600">+8.2%</span>
                </div>
              </div>
          ...
          <Card className="p-4 lg:p-5 bg-white rounded-2xl shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs lg:text-sm text-gray-600">Saving Rate</p>
                <p className="text-xl lg:text-2xl font-bold text-gray-900 mt-1">{savingRate}%</p>
                <p className="text-[10px] lg:text-xs text-gray-500 mt-2">Of income</p>
              </div>
        ...
        {(highestCategory || budgetWarnings.length > 0) && (
          <Card className="p-4 lg:p-5 bg-amber-50 border-amber-200 rounded-2xl">
            <div className="flex items-start gap-3">
              <AlertCircle className="w-5 h-5 text-amber-600 mt-0.5" />
              <div className="flex-1">
                <h3 className="font-semibold text-amber-900 text-sm lg:text-base">Quick Insights</h3>
                <ul className="mt-2 space-y-1 text-xs lg:text-sm text-amber-800">
                  {highestCategory && (
                    <li>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-4 lg:p-6 bg-white rounded-2xl shadow-sm">
            <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Expenses by Category</h3>
            {pieData.length > 0 ? (
          ...
          {/* Cashflow Chart */}
          <Card className="p-4 lg:p-6 bg-white rounded-2xl shadow-sm">
            <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Cashflow (Last 7 Days)</h3>
        ...
        {/* Recent Transactions */}
        <Card className="p-4 lg:p-6 bg-white rounded-2xl shadow-sm">
          <h3 className="text-base lg:text-lg font-semibold text-gray-900 mb-4">Recent Transactions</h3>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 lg:gap-3">
                      ...
                      <div>
                        <p className="text-sm lg:text-base font-medium text-gray-900">{transaction.category}</p>
